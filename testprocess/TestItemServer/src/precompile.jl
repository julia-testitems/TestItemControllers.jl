...
function _precompile_()
    ...
    precompile(Tuple{typeof(cpu_target_base_variant), String})
    precompile(Tuple{typeof(portable_precompile_applies), Nothing})
    precompile(Tuple{typeof(portable_precompile_applies), String})
